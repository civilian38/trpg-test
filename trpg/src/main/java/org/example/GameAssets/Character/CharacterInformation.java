...
public enum CharacterInformation {
    LUCY_INFO(
            ...
            new ArrayList<>(List.of(
                    new CharacterRelationship(25, CharacterID.REED_ID.getID(), CharacterRelationshipType.RELATIONSHIP_PARTNER, "이전 동료")
            ))
    ), REED_INFO(
            "솔로몬 리드",
            ...
            new ArrayList<>(List.of(
                    new CharacterRelationship(0, CharacterID.LUCY_ID.getID(), CharacterRelationshipType.RELATIONSHIP_NEUTRAL, "안타까운 아라사카의 희생양"),
                    new CharacterRelationship(25, CharacterID.ALEX_ID.getID(), CharacterRelationshipType.RELATIONSHIP_PARTNER, "과거의 동료")
            ))
    );
    ...
    private ArrayList<CharacterRelationship> relationships;
    CharacterInformation(String cName,
                         ...
                         ArrayList<CharacterRelationship> relationships) {
        this.id = cID;
        this.name = cName;
    ...
    public ArrayList<CharacterRelationship> getRelationships() {
